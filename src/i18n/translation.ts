export const FRONT = {
  ...
  TYPESCRIPT: {
    ...
    class: "text-blue-400/90",
  },
  JAVASCRIPT: {
    name: "JavaScript",
    svg: `<svg class ='size-7' width="256" height="256" viewBox="0 0 1052 1052" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"><path fill="#f0db4f" d="M0 0h1052v1052H0z"/><path d="M965.9 801.1c-7.7-48-39-88.3-131.7-125.9-32.2-14.8-68.1-25.399-78.8-49.8-3.8-14.2-4.3-22.2-1.9-30.8 6.9-27.9 40.2-36.6 66.6-28.6 17 5.7 33.1 18.801 42.8 39.7 45.4-29.399 45.3-29.2 77-49.399-11.6-18-17.8-26.301-25.4-34-27.3-30.5-64.5-46.2-124-45-10.3 1.3-20.699 2.699-31 4-29.699 7.5-58 23.1-74.6 44-49.8 56.5-35.6 155.399 25 196.1 59.7 44.8 147.4 55 158.6 96.9 10.9 51.3-37.699 67.899-86 62-35.6-7.4-55.399-25.5-76.8-58.4-39.399 22.8-39.399 22.8-79.899 46.1 9.6 21 19.699 30.5 35.8 48.7 76.2 77.3 266.899 73.5 301.1-43.5 1.399-4.001 10.6-30.801 3.199-72.101zm-394-317.6h-98.4c0 85-.399 169.4-.399 254.4 0 54.1 2.8 103.7-6 118.9-14.4 29.899-51.7 26.2-68.7 20.399-17.3-8.5-26.1-20.6-36.3-37.699-2.8-4.9-4.9-8.7-5.601-9-26.699 16.3-53.3 32.699-80 49 13.301 27.3 32.9 51 58 66.399 37.5 22.5 87.9 29.4 140.601 17.3 34.3-10 63.899-30.699 79.399-62.199 22.4-41.3 17.6-91.3 17.4-146.6.5-90.2 0-180.4 0-270.9z" fill="#323330"/></svg>`,
    class: "text-yellow-300/90",
  },
};
...
export const BACK = {
  JAVA: {
    name: "Java",
    svg: `<svg class ='size-7' xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 346">
  ...
  PHP: {
    name: "PHP",
    svg: `<svg class ='size-7'xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 711.20123 383.5975">
...
export const DB = {
  MYSQL: {
    name: "MySQL",
    svg: `<svg class ='size-7' xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 252">
...
export const CLOUD = {
  AWS: {
    name: "AWS",
    svg: `<svg class ='size-7' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 304 182" style="enable-background:new 0 0 304 182" xml:space="preserve">
            <style>
...
export const FRAMEWORKS = {
  SPRING: {
    name: "Spring",
    svg: `<svg class ='size-7' viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width="64" height="64">
            <path d="M58.2 3.365a29.503 29.503 0 0 1-3.419 6.064A32.094 32.094 0 1 0 9.965 55.372l1.186 1.047a32.08 32.08 0 0 0 52.67-22.253c.875-8.17-1.524-18.51-5.62-30.8zM14.53 55.558a2.744 2.744 0 1 1-.404-3.857 2.744 2.744 0 0 1 .404 3.857zm43.538-9.61c-7.92 10.55-24.83 6.99-35.672 7.502 0 0-1.922.113-3.857.43 0 0 .73-.31 1.663-.663 7.614-2.65 11.213-3.16 15.838-5.54 8.708-4.427 17.322-14.122 19.112-24.2-3.313 9.695-13.373 18.032-22.53 21.418-6.276 2.313-17.614 4.566-17.614 4.566l-.457-.245c-7.714-3.75-7.952-20.457 6.077-25.845 6.143-2.366 12.02-1.067 18.654-2.65 7.084-1.683 
            15.28-6.99 18.615-13.916 3.73 11.08 8.224 28.422.166 39.15z" fill="#68bd45"/></svg>`,
    class: "text-green-300/90",
  },
};
...
export const VERSION_CONTROL = {
  GIT: {
    name: "Git",
    svg: `<svg class ='size-7' xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
...
`,
  ...
  GITHUB: {
    name: "Github",
    svg: `<svg class ='size-7' viewBox="0 0 256 256" width="256" height="256" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
...
export const INTEGRATION = {
  SONAR: {
    name: "Sonar",
    svg: `<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="currentColor"  class="icon icon-tabler icons-tabler-filled icon-tabler-point"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 7a5 5 0 1 1 -4.995 5.217l-.005 -.217l.005 -.217a5 5 0 0 1 4.995 -4.783z" /></svg>`,
    class: "text-blue-300/90",
  },
  JENKINS: {
    name: "Jenkins",
  ...
  PROJECT_EN: [
    {
      ...
      link: "https://gamemania-frontend.onrender.com",
    ...
    },
    {
      ...
      link: "",
      tags: [BACK.JAVA, FRAMEWORKS.SPRING, DB.POSTGRESQL],
      image: "",
    },
  ],
  PROJECT_ES: [
    {
      ...
      github: "https://github.com/Sergio-JG/GameMania",
      link: "https://gamemania-frontend.onrender.com",
      tags: [FRONT.REACT, FRONT.TYPESCRIPT],
      image: "/projects/Gamemania.webp",
    },
...
export const ui = {
  es: {
    ...
    //
    footer_copyright: "2025 Sergio-JG. Hola Mundo.",
  },
  en: {
    ...
    //
    footer_copyright: "2025 Sergio-JG. Hello World.",
  },
} as const;
